...
export const metadata: Metadata = {
  title: "Bee Job - Premium Handcrafted Flowers & Bouquets",  description: "Discover exquisite handcrafted floral arrangements from Bee Job. Fresh premium flowers delivered same-day. Perfect for weddings, anniversaries, and special occasions.",  keywords: "flowers, bouquets, floral arrangements, flower delivery, premium flowers, handcrafted arrangements",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Bee Job - Premium Floral Arrangements",    description: "Handcrafted bouquets with the freshest, most vibrant blooms. Same-day delivery available.",    type: "website",    siteName: "Bee Job",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/bouquet-pink-roses-single-branch-rose-with-green-leaves-inside-vase_114579-1440.jpg",        alt: "Premium flower arrangement"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Bee Job - Premium Flowers",    description: "Exquisite handcrafted floral arrangements for every occasion",    images: ["https://img.b2bpic.net/free-photo/bouquet-pink-roses-single-branch-rose-with-green-leaves-inside-vase_114579-1440.jpg"],
  },
};
